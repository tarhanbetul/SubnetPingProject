...
CACHES = {
    "default": {
        ...
        "LOCATION": "redis://redis:6379/1",  # Redis servisi adını ve portunu kullanın
        "OPTIONS": {
...
CELERY_BROKER_URL = 'redis://redis:6379/0'  # Redis bağlantı URL'sini projenizin ayarlarına uygun şekilde güncelleyin.
CELERY_RESULT_BACKEND = 'redis://redis:6379/0'  # Sonuçları saklamak için Redis'i kullanın, bağlantı bilgilerini güncelleyin.
